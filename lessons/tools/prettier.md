---
description: "Prettier, a tool that that helps you maintain consistent code style with no work on the dev's part."
---

## Code Quality

It's important to keep quality high when writing code. In reality I'm super lazy and want the machine to do as much work as possible so I can focus more on problem-solving and less on syntax and style. While there are many tools that can help you keep code quality high, these two I consider core to my workflow.
